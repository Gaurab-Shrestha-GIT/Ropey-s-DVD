<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FeatureTwo.aspx.cs" Inherits="GroupCoursework.FeatureTwo" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="mt-4 text-center">
            <div>
                <h3>At Least One Film Played by Actor</h3>
            </div>
            <div>
                Actor Surname:
                <asp:DropDownList ID="ActorSurnameDropDownList" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ActorSurnameDropDownList_SelectedIndexChanged"></asp:DropDownList>
