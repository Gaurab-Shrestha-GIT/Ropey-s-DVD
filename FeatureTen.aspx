<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FeatureTen.aspx.cs" Inherits="GroupCoursework.FeatureTen" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="mt-4 text-center">
            <h3>Delete DVD that is more than 365 days</h3>
            <div>
                <asp:Button ID="Button1" runat="server" Text="Delete DVD" OnClick="Button1_Click" />
            </div>
            <div class="mt-4">
