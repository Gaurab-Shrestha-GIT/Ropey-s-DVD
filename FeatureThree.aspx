<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FeatureThree.aspx.cs" Inherits="GroupCoursework.FeatureThree" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="text-center mt-4">
            <h3>DVD Loaned By Member in Last 31 Days</h3>
            <div>
                Member Last Name:
                   <asp:DropDownList ID="MemberLastNameDropDownList" runat="server" AutoPostBack="true" OnSelectedIndexChanged="MemberLastNameDropDownList_SelectedIndexChanged"></asp:DropDownList>
