<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FeatureOne.aspx.cs" Inherits="GroupCoursework.ActorFilm" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="text-center">
            ...
            <div class="mt-4">
                <h3>Actor as Cast Member</h3>
                Actor Last Name:
                <asp:DropDownList ID="ActorLastNameDropDownList" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ActorLastNameDropDownList_SelectedIndexChanged"></asp:DropDownList>
            </div>
