<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FeatureFour.aspx.cs" Inherits="GroupCoursework.DVDCastLists" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>DVD Cast Lists</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="mt-4 text-center">
            <h3>Sort By Date Released and Cast Member</h3>
            <asp:Label ID="resultLabel" runat="server"></asp:Label>
            <asp:Label ID="Label1" runat="server" Text="Sort By:">
            </asp:Label><asp:Button ID="Button1" runat="server" Text="Date Released" OnClick="Button1_Click" />
            <asp:Label ID="Label2" runat="server" Text="Sort By:">
            </asp:Label><asp:Button ID="Button2" runat="server" Text="Actor Surname" OnClick="Button2_Click" />

        </div>
        <div class="mt-4">
            <asp:GridView ID="GridView1" HorizontalAlign="Center" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None">
