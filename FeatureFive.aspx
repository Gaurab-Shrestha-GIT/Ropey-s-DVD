<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FeatureFive.aspx.cs" Inherits="GroupCoursework.DetailsByCopyNumber" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="mt-4 text-center">
            <h3>Loan Details by Copy Number</h3>
            Copy Number:
            <asp:DropDownList ID="CopyNumberDropDownList" runat="server" AutoPostBack="true" OnSelectedIndexChanged="CopyNumberDropDownList_SelectedIndexChanged"></asp:DropDownList>
