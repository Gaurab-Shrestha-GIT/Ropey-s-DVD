<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Producer.aspx.cs" Inherits="GroupCoursework.Producer" %>
        ...
        <div>
            <div class="mt-2 " style="background-color: lightblue; width: 450px; height: 180px; margin-left: 37%; border-radius: 10px;">
                <div class="text-center" style="margin-top: 20px; font-size: 20px; font-weight: bold; color: darkblue;">
                    PRODUCER 
                    <asp:TextBox ID="Text_Producer_Number" runat="server" type="hidden"></asp:TextBox>

                </div>
                <div class="text-center mt-3">
                    Producer Name: 
 <asp:TextBox ID="Text_Producer_Name" runat="server"></asp:TextBox>
                ...
                <div class="text-center" style="margin-top: 15px;">
                    <asp:Button ID="AddProducerButton" runat="server" Text="ADD PRODUCER" OnClick="AddProducerButton_Click" />
            ...
            <div class="mt-5" style="margin-left: 42%;">
                <asp:GridView ID="ProducerGridView" runat="server" OnRowCommand="GVProducer_RowCommand" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Producer Name">
                            <ItemTemplate>
                                ...
                                <asp:Label ID="lblProducerName" runat="server" Text='<%#Eval("Producer_Name") %>'>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:LinkButton ID="View" runat="server" CommandName="view" CommandArgument='<%#Bind("Producer_Number") %>'>
                                            Edit
                                </asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
