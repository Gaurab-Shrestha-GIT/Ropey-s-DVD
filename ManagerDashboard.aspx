<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManagerDashboard.aspx.cs" Inherits="GroupCoursework.ManagerDashboard" %>
...
<body>
    <form id="form1" runat="server">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item" style="margin-left: 35px;">
                            <a class="nav-link active" aria-current="page" href="ManagerDashboard.aspx">Dashboard</a>
                        </li>
                        ...
                        <li style="margin-left: 58em;">
                            <asp:Button ID="Button1" runat="server" Text="Logout" OnClick="Button1_Click" /></li>
                    </ul>
        ...
        <div style="font-size: 30px; text-align: center; margin-top: 15px;">
            WELCOME "<asp:Label ID="Label1" runat="server" Text=""></asp:Label>" to MANAGER DASHBOARD
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <div class="card">
                        <a href="FeatureThriteen.aspx">DVD Not Loaned
                        </a>
                    </div>
                ...
                <div class="col">
                    <div class="card">
                        <a href="ChangeManagerPassword.aspx">Change Password
                        </a>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-4 col">
                    <div class="card">
                        ...
                        <a href="AssistantDetails.aspx">Assistant Details
                        </a>
                    </div>
