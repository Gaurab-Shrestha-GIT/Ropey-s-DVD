<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CastMember.aspx.cs" Inherits="GroupCoursework.CastMember" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <div class="mt-2 " style="background-color: lightblue; width: 450px; height: 180px; margin-left: 37%; border-radius: 10px;">
                ...
                <div class="text-center" style="margin-top: 10px;">
                    ...
                    <div>
                        Actor Number:  
                        <asp:DropDownList ID="ActorNumberDropDownList" runat="server"></asp:DropDownList>

                    </div>

                </div>
                <div class="text-center" style="margin-top: 15px;">
                    <asp:Button ID="AddCastMemberButton" runat="server" Text="ADD CAST MEMBER" OnClick="AddCastMemberButton_Click" />
                </div>
        ...
        <div class="mt-4" style="margin-left: 45%;">
            <asp:GridView ID="CastMemberGridView" runat="server" CellPadding="4" ForeColor="#333333" OnRowCommand="GVCastMember_RowCommand" GridLines="None" AutoGenerateColumns="False">
