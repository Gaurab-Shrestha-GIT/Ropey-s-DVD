<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Studio.aspx.cs" Inherits="GroupCoursework.Studio" %>
        ...
        <div>
            <div class="mt-2 " style="background-color: lightblue; width: 450px; height: 180px; margin-left: 37%; border-radius: 10px;">
                <div class="text-center" style="margin-top: 20px; font-size: 20px; font-weight: bold; color: darkblue;">
                    STUDIO 
                    <asp:TextBox ID="Text_Studio_Number" runat="server" type="hidden"></asp:TextBox></asp:TextBox>

                </div>
                <div class="text-center mt-3">
                    Studio Name: 
                    <asp:TextBox ID="Text_Studio_Name" runat="server"></asp:TextBox>
                ...
                <div class="text-center" style="margin-top: 15px;">
                    <asp:Button ID="AddStudioButton" runat="server" Text="ADD STUDIO" OnClick="AddStudioButton_Click" />
            ...
            <div class="mt-5" style="margin-left: 42%;">
                <asp:GridView ID="StudioGridView" runat="server" OnRowCommand="GVStudio_RowCommand" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Studio Name">
                            <ItemTemplate>
                                ...
                                <asp:Label ID="lblStudioName" runat="server" Text='<%#Eval("Studio_Name") %>'>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:LinkButton ID="View" runat="server" CommandName="view" CommandArgument='<%#Bind("Studio_Number") %>'>
                                            Edit
                                </asp:LinkButton>
                            </ItemTemplate>
                        </asp:TemplateField>
